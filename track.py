...
def detect(opt, _source=None, _yolo_model=None, _classes=None, _save_vid=None, _save_txt=None, _show_vid=None):
    ...
    if _show_vid!=None:     show_vid=_show_vid
                ...
                if len(outputs[i]) > 0:
                    for j, (output) in enumerate(outputs[i]):
                        ...
                        if save_txt:
                            ...
                            results.append(str([frame_idx+1, id, bbox_left, bbox_top, bbox_w, bbox_h, -1, -1, -1, 0]))
                            # print (bounding)
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        detect(opt, _source='test_trafficb480_trim1.mp4', _yolo_model='yolov5s.pt', _save_vid=False, _save_txt=True, _classes=[2], _show_vid=True), 
